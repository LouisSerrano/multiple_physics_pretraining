...
try:
    from spatial_modules import hMLP_stem, hMLP_output, SubsampledLinear, hMLP_step1d,  hMLP_Ouptut1d, AxialAttentionBlock, SpatialAttentionBlock1d
    from mixed_modules import build_spacetime_block, SpaceTimeBlock, SpaceTimeBlock
except:
    from .spatial_modules import hMLP_stem, hMLP_output, SubsampledLinear, hMLP_step1d,  hMLP_Ouptut1d
